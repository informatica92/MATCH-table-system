...
if st.session_state.location_mode != "default" or st.session_state.proposition_type_id_mode is not None:
    st.session_state.location_mode = "default"
    st.session_state.proposition_type_id_mode = None
    StreamlitTablePropositions.refresh_table_propositions("Loading Default page")
